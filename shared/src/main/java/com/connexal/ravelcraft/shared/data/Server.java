...
public enum Server {
    ...
    Server(String name, String address, int port, boolean bedrockProxy, boolean javaProxy, boolean lobby, String directConnect) {
        this.name = name;
    ...
    Server(String name, String address, int port, boolean bedrockProxy, boolean javaProxy, boolean lobby) {
        this(name, address, port, bedrockProxy, javaProxy, lobby, null);
    }

    Server(String name, String address, int port, String directConnect) {
