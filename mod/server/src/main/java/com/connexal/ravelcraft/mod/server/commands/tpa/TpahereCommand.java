...
public class TpahereCommand extends RavelCommand {
    @Override
    ...
    protected boolean run(RavelCommandSender sender, String[] args) {
        ...
        this.completeAsync(() -> {
            ...
            RavelModServer.getTpaManager().queueRequest(source, (FabricRavelPlayer) target, TpaManager.TpaType.RECEIVER_TO_SENDER);
        });
