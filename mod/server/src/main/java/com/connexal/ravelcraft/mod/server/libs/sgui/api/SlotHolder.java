package com.connexal.ravelcraft.mod.server.libs.sgui.api;

import com.connexal.ravelcraft.mod.server.libs.sgui.api.elements.GuiElement;
import com.connexal.ravelcraft.mod.server.libs.sgui.api.elements.GuiElementBuilderInterface;
...
public interface SlotHolder {
     ...
     * @throws IndexOutOfBoundsException if the slot is out of bounds
     * @see SlotHolder#addSlot(ItemStack, GuiElementInterface.ClickCallback)
     */
    default void setSlot(int index, ItemStack itemStack, GuiElementInterface.ClickCallback callback) {
     ...
     * @param itemStack a stack of items
     * @param callback  the callback to run when clicked
     * @see SlotHolder#setSlot(int, ItemStack, GuiElementInterface.ClickCallback)
     */
    default void addSlot(ItemStack itemStack, GuiElementInterface.ClickCallback callback) {
